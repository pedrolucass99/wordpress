<?php
function aromatic_slider3_setting( $wp_customize ) {
$selective_refresh = isset( $wp_customize->selective_refresh ) ? 'postMessage' : 'refresh';
	...
	$wp_customize->add_panel(
		'aromatic_frontpage2_sections', array(
			'priority' => 32,
			'title' => esc_html__( 'Frontpage Sections', 'aromatic-pro' ),
		)
	);
	
	$wp_customize->add_section(
		'slider3_setting', array(
			'title' => esc_html__( 'Slider Section', 'aromatic-pro' ),
	...
	'slider3_content_head',
		array(
			'type' => 'hidden',
			'label' => __('Contents','aromatic-pro'),
			'section' => 'slider3_setting',
		)
	);
	 ...
	 */
		...
		$wp_customize->add_setting( 'slider3', 
			array(
			 ...
			 'priority' => 5,
			  'default' => aromatic_get_slider3_default()
			)
		);
		...
		$wp_customize->add_control( 
			new Aromatic_Repeater( $wp_customize, 
				'slider3', 
					array(
						'label'   => esc_html__('Slider','aromatic-pro'),
						'section' => 'slider3_setting',
						'add_field_label'                   => esc_html__( 'Add New Slider', 'aromatic-pro' ),
						'item_name'                         => esc_html__( 'Slider', 'aromatic-pro' ),
...
add_action( 'customize_register', 'aromatic_slider3_setting' );