        ...
        <div class="wopb-filter-section">
            ...
            <div class="wopb-filter-body">
                <div class="wopb-search-filter-body">
                    ...
                    <input type="search" class="wopb-filter-search-input" placeholder="<?php _e('Search Products', 'product-blocks') ?>..."/>
        ...
        <div class="wopb-filter-section">
            ...
            <div class="wopb-filter-body">
                <input
                    ...
                    data-term-limit="<?php esc_attr_e($params['term_limit']) ?>"
                ...
                <?php
                    if( $params['taxonomy']->total_terms > $params['term_limit']) {
                        $item_total_page = ceil($params['taxonomy']->total_terms / $params['term_limit']);
                ?>
